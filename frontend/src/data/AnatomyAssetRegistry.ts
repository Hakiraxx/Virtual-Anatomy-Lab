...
const RAW_ENTRIES: AnatomyAssetEntry[] = [
  ...
  {
    id: 'nerve.infraorbital',
    canonicalId: 'nerve.infraorbital',
    legacyId: 'nerve_infraorbital',
    nameVi: 'Thần kinh dưới ổ mắt',
    nameEn: 'Infraorbital Nerve',
    latinName: 'Nervus infraorbitalis',
    synonyms: ['TK dưới ổ mắt', 'Infraorbital nerve', 'Nhánh tận V2'],
    region: 'ORBIT',
    laterality: 'BILATERAL',
    modelUrl: '/models/craniofacial/cranial-nerves/cranial_nerves_complete.glb',
    nodeNames: {
      right: 'Infraorbital nerve.r',
      left: 'Infraorbital nerve.l'
    },
    type: 'ANATOMICAL_MESH',
    source: 'Z-Anatomy / BodyParts3D',
    license: 'CC BY-SA 4.0',
  ...
  {
    id: 'nerve.incisive',
    canonicalId: 'nerve.incisive',
    legacyId: 'nerve_incisive',
    nameVi: 'Thần kinh răng cửa',
    nameEn: 'Incisive Nerve',
    latinName: 'Nervus incisivus',
    synonyms: ['TK răng cửa', 'Incisive nerve', 'Nhánh tận IAN'],
    region: 'MANDIBLE',
    laterality: 'BILATERAL',
    modelUrl: '/models/craniofacial/cranial-nerves/cranial_nerves_complete.glb',
    nodeNames: {
      right: 'Incisive nerve.r',
      left: 'Incisive nerve.l'
    },
    type: 'ANATOMICAL_MESH',
    source: 'Z-Anatomy / BodyParts3D',
    license: 'CC BY-SA 4.0',
  ...
  {
    id: 'nerve.cn9',
    canonicalId: 'nerve.cn9',
    legacyId: 'nerve_cn_9',
    nameVi: 'Dây thần kinh thiệt hầu (Dây IX)',
    nameEn: 'Glossopharyngeal Nerve (CN IX)',
    latinName: 'Nervus glossopharyngeus',
    synonyms: ['CN IX', 'Dây IX', 'Thiệt hầu', 'Glossopharyngeal nerve'],
    region: 'NECK',
    laterality: 'BILATERAL',
    modelUrl: '/models/craniofacial/cranial-nerves/cranial_nerves_complete.glb',
    nodeNames: {
      right: 'Glossopharyngeal nerve (IX).r',
      left: 'Glossopharyngeal nerve (IX).l'
    },
    type: 'ANATOMICAL_MESH',
    source: 'Z-Anatomy / BodyParts3D',
    license: 'CC BY-SA 4.0',
  ...
  },
  {
    ...
    category: 'cranial_nerve',
    reviewStatus: 'VERIFIED',
    references: ["Gray's Anatomy 42nd Ed, p. 594"]
  },
  {
    id: 'nerve.accessory',
    canonicalId: 'nerve.accessory',
    legacyId: 'nerve_cn_11',
    nameVi: 'Dây thần kinh phụ (Dây XI)',
    nameEn: 'Accessory Nerve (CN XI)',
    latinName: 'Nervus accessorius',
    synonyms: ['CN XI', 'Dây XI', 'Thần kinh phụ', 'Accessory nerve'],
    region: 'NECK',
    laterality: 'BILATERAL',
    modelUrl: '/models/craniofacial/cranial-nerves/cranial_nerves_complete.glb',
    nodeNames: {
      right: 'Accessory nerve (XI).r',
      left: 'Accessory nerve (XI).l'
    },
    type: 'ANATOMICAL_MESH',
    source: 'Z-Anatomy / BodyParts3D',
    license: 'CC BY-SA 4.0',
    ...
    category: 'cranial_nerve',
    reviewStatus: 'VERIFIED',
    references: ["Gray's Anatomy 42nd Ed, p. 596"]
  },
  {
    id: 'nerve.hypoglossal',
    canonicalId: 'nerve.hypoglossal',
    legacyId: 'nerve_cn_12',
    nameVi: 'Dây thần kinh hạ thiệt (Dây XII)',
    nameEn: 'Hypoglossal Nerve (CN XII)',
    latinName: 'Nervus hypoglossus',
    synonyms: ['CN XII', 'Dây XII', 'Thần kinh hạ thiệt', 'Hypoglossal nerve'],
    region: 'HEAD',
    laterality: 'BILATERAL',
    modelUrl: '/models/craniofacial/cranial-nerves/cranial_nerves_complete.glb',
    nodeNames: {
      right: 'Hypoglossal nerve (XII).r',
      left: 'Hypoglossal nerve (XII).l'
    },
    type: 'ANATOMICAL_MESH',
    source: 'Z-Anatomy / BodyParts3D',
    license: 'CC BY-SA 4.0',
    ...
    category: 'cranial_nerve',
    reviewStatus: 'VERIFIED',
    references: ["Gray's Anatomy 42nd Ed, p. 598"]
  },
