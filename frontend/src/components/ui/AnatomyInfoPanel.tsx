...
export const AnatomyInfoPanel: React.FC = () => {
  ...
  if (!structure) {
    return (
      <>
        {/* Only show dark backdrop when user explicitly expands on mobile/tablet */}
        {isInfoExpanded && (
          <div
        ...
        <aside className="fixed bottom-3 right-3 left-3 sm:left-auto sm:w-96 z-40 pointer-events-auto transition-all duration-300">
          <AnatomyInfoCard
  ...
  return (
    <>
      ...
      {/* Floating Card / Bottom Sheet Container */}
      <aside className="fixed bottom-3 right-3 left-3 sm:left-auto sm:w-96 z-40 pointer-events-auto transition-all duration-300">
        <AnatomyInfoCard
